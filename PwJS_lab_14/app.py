...
def login():
    dane = {'tytul': 'Zaloguj sie', 'tresc': 'To jest logowanie...'}
...
def logout():
    logout_user()
    dane = {'tytul': 'Wylogowanie', 'tresc': 'To jest wylogowanie...'}
    return render_template('logout.html', tytul = dane['tytul'], tresc = dane['tresc'])
...
@login_required
def dodaj():
    dane = {'tytul': 'Dodaj pracownika', 'tresc': 'To jest dodawanie pracownikow...'}
...
@login_required
def lista():
    dane = {'tytul': 'Lista pracownikow', 'tresc': 'To jest lista pracownikow...'}
